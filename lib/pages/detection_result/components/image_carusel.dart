      ...
      body: WillPopScope(
        ...
        child: Obx(
          () => ExtendedImageGesturePageView.builder(
            ...
            controller:
                ExtendedPageController(initialPage: controller.currentIndex),
            scrollDirection: Axis.horizontal,
            itemBuilder: (BuildContext context, int index) {
              String img = controller.detectionResult.value!.images[index].url;
              // controller.selectedIndex.clear();
              // controller.selectedIndex
              //     .add(controller.detectionResult!.images[index]);
